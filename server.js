...
/// added as a "catch-all" for react router, so index.html is sent to allow react router to render the appropriate endpoint
...
app.post('/new-entry', (req, res) => {
  ...
  addEntry(entry)
    .then(res.status(301).redirect('http://localhost:3000/'));
