    ...
    <div className="tabs-new-entry">
      <div className="form">
        <form action={formSettings.formAction} method="post">
          <div className="form-title">{formSettings.title}</div>
        ...
        <div id="upload-csv-tab" className="tab-content-upload">
          ...
          <div className="tip-upload-csv">
            <a href="./../../mcanon-template.csv" download>
            ...
            <div className="tip-upload-csv-question">
              <div className="tip-upload-csv-title">
                <strong> To Use The CSV Template File: </strong>
                <br />
              </div>
              <div>
              ...
              <div className="tip-upload-csv-items">
                ...
                ALBUM: <i>title of the album</i>
                <br />
                YEAR: <i>four digit number (i.e., 1991)</i>
                <br />
                GENRE: <i>see dropdown for all options</i>
                <br />
                MOOD: <i>upbeat, daytime, or chill</i>
                <br />
                RATING: <i>1, 2, or 3</i>
                <br />
                COLLECTION: <i>canon or nominee</i>
                <br />
                INSTRUMENTAL: <i>yes or no</i>
                <br />
              </div>
            </div>
          </div>
